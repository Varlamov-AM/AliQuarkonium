...
int main(int argc, char* argv[]){
    ...
    TH2D* proton_pt_eta = 
        new TH2D("proton_pt_eta", 
                 ...
                 1000., 0., 10., 
                 1000, -0.6, 0.6);
    TH2D* antiproton_pt_eta = 
        new TH2D("antiproton_pt_eta", 
                 "antiproton_pt_eta", 
                 1000., 0., 10., 
                 1000, -0.6, 0.6);
    TH2D* kaon_pt_eta = 
    ...
    TH2D* neutron_pt_eta = 
        new TH2D("neutron_pt_eta", 
                 ...
                 1000., 0., 10., 
                 1000, -0.6, 0.6);
    TH2D* antineutron_pt_eta = 
        new TH2D("antineutron_pt_eta", 
                 "antineutron_pt_eta", 
                 1000., 0., 10., 
                 1000, -0.6, 0.6);
    ...
    gamma_pt_eta->Sumw2();
    proton_pt_eta->Sumw2();
    antiproton_pt_eta->Sumw2();
    kaon_pt_eta->Sumw2();
    pion_pt_eta->Sumw2();
    kaonl_pt_eta->Sumw2();
    neutron_pt_eta->Sumw2();
    antineutron_pt_eta->Sumw2();
    ...
    TH2D* neutron_p_e = 
        new TH2D("neutron_p_e", 
                 ...
                 1000, 0., 20., 
                 1000., 0., 20.);
    TH2D* antineutron_p_e = 
        new TH2D("antineutron_p_e", 
                 "antineutron_p_e", 
                 1000, 0., 20., 
                 1000., 0., 20.);
    electrons_p_e->Sumw2();
    ...
    gamma_p_e->Sumw2();
    proton_p_e->Sumw2();
    antiproton_p_e->Sumw2();
    kaon_p_e->Sumw2();
    pion_p_e->Sumw2();
    kaonl_p_e->Sumw2();
    neutron_p_e->Sumw2();
    antineutron_p_e->Sumw2();
    ...
    for (int i = 0; i < chain->GetEntries(); ++i){
        ...
        for (auto charg : charged){
            ...
            if (charg.id == -idp){
                antiproton_pt_eta->Fill(charg.FMomentum().Pt(), charg.FMomentum().Eta());
                antiproton_p_e->Fill(charg.FMomentum().P(), charg.FMomentum().E());
            }
            if (charg.id == idKc){
        ...
        for (auto neutr : neutral){
            ...
            if (neutr.id == -idn){
                antineutron_pt_eta->Fill(neutr.FMomentum().Pt(), neutr.FMomentum().Eta());
                antineutron_p_e->Fill(neutr.FMomentum().P(), neutr.FMomentum().E());
            }
            if (neutr.id == idK0L){
    ...
    gamma_pt_eta->Write();
    proton_pt_eta->Write();
    antiproton_pt_eta->Write();
    kaon_pt_eta->Write();
    pion_pt_eta->Write();
    neutron_pt_eta->Write();
    antineutron_pt_eta->Write();
    kaonl_pt_eta->Write();
    ...
    gamma_p_e->Write();
    proton_p_e->Write();
    antiproton_p_e->Write();
    kaon_p_e->Write();
    pion_p_e->Write();
    neutron_p_e->Write();
    antineutron_p_e->Write();
    kaonl_p_e->Write();
